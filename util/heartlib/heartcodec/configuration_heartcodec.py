...
class HeartCodecConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        # Diffusion transformer settings
        ...
        # ScalarCodec audio settings
        num_bands: int = 1,
        sample_rate: int = 48000,
        causal: bool = True,
        num_samples: int = 2,
        downsample_factors: List[int] = None,
        downsample_kernel_sizes: List[int] = None,
        ...
        **kwargs,
        ...
        self.downsample_factors = downsample_factors or [3, 4, 4, 4, 5]
        self.downsample_kernel_sizes = downsample_kernel_sizes or [6, 8, 8, 8, 10]
        self.upsample_factors = upsample_factors or [5, 4, 4, 4, 3]
        self.upsample_kernel_sizes = upsample_kernel_sizes or [10, 8, 8, 8, 6]
